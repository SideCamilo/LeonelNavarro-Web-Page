...
$output_string .='
	<div class="container " style="height:600px; width: 100%; overflow:scroll;">
		<br /><div class = "container">
			<div class="row" >
				...
				<div class = "col-md-2">
					<img src = "img/close.png" id="cerrarventana" class="fa fa-times-circle" aria-hidden="true" onclick="cerrari()" style = "width: 25px; height: 25px; cursor:pointer; position:relative; left:97%;"  />
				</div>
			</div>
		</div><br />
	...
	<div class = "container">
				<div class = "row">
					...
					<div class = "col-md-4" style = "height: 500px; overflow: scroll; color: white; border:solid  #ffffff; border-width: 2px;">
						...
						<h1> <b>Inversión:</b>'.$row_sql_buscar['inversion'].'</h1>
						<h1> <b>Incluye Inversión:</b>'.$row_sql_buscar['incluyeinversion'].'</h1>
						<h1> <b>Proyecto:</b>'.$row_sql_buscar['proyecto'].'</h1>
						<h1> <b>Rendimiento:</b>'.$row_sql_buscar['rendimiento'].'</h1>
						<h1> <b>Cadena:</b>'.$row_sql_buscar['cadena'].'</h1>
						<h1> <b>Tiempo:</b>'.$row_sql_buscar['tiempo'].'</h1>
					</div>
				</div>
			</div>
	</div>
