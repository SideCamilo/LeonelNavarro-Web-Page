...
/////////////////////////LEE CLIENTES
$buscar = 'SELECT p.*, e.estado as nombre_estado, z.zona as nombre_zona FROM propiedades p, estados e, zonas z where p.estado = e.id and p.zona = z.id and publica = "N" order by p.id ASC limit 3';
