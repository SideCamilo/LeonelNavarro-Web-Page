...
/////////////////////////LEE CLIENTES
$buscar = 'SELECT p.*, e.estado as nombre_estado, z.zona as nombre_zona FROM propiedades p, estados e, zonas z where p.estado = e.id and p.zona = z.id and publica = "S" order by p.id ASC limit 3';
				...
				<div class="carousel-inner">
					<div class="item active">
						<img style = "width:100%; height: 300px;" id = "" src = "../img/prop/'.$row_sql_buscar['imagen'].'" alt = "'.$row_sql_buscar['nombre'].'" onclick="prop('.$row_sql_buscar['id'].')"/>
						    <div class="carousel-caption" style = "width: 290px; padding-bottom: 5px; left: 5px; bottom: 0px;">
